...
这是一个单页 Web 应用程序，能生成荒谬但在语法上正确、充满选举修辞风格的浮夸帖子。生成器内置了典型的演讲模式、国家名称、现任政治家的名字以及标志性的史诗感。
...
* **多角色信息流**：时间线融合了几个色彩鲜明的人物。这里有一个抽象的“POTUS”（明显以唐纳德·特朗普为原型）、“Zhirik”（V. 日里诺夫斯基，带着他的企鹅和印度洋）、“The Patriot”（德米特里·梅德韦杰夫和他的放射性灰烬）以及“El Anarcap”（哈维尔·米莱，带着电锯和奥地利经济学派）。新帖子会随机以他们中任何人的名义生成。
...
1. **双击**角色头像 — 瞬间生成一条来自该特定政治家的新帖子。
2. **“橡皮擦”手势** — 在一秒钟内将光标在头像上快速悬停并移开 3 次。该帖子将消失在虚无中。
3. **验证码破解** — 如果您懒得输入成年人暗号，只需在一秒钟内将光标在验证码图片本身上快速滑动 3 次。该暗号将自动复制到输入框中。
